...
const About = ({ btnHover, contactRef, showResume, setShowResume }) => {
  ...
  return (
    <div className="w-full lg:flex items-center gap-[1rem] justify-between ">
      <div className="lg:w-[40%]" data-aos="fade-right">
        <div
          className="lg:hidden lg:w-[60%] text-white  p-4 flex flex-col justify-start  items-start "
          data-aos="fade-left"
        >
          <h2 className=" lg:flex font-[Roboto] font-bold text-[30px]">
            About Me
          </h2>
          <div className="mt-5">
          ...
          <div className=" flex justify-between items-center  gap-[3rem] mt-5">
            <button
      ...
      <div
        className="hidden lg:w-[60%] text-white  p-4 lg:flex flex-col justify-start  items-start "
        data-aos="fade-left"
      >
        <h2 className="hidden lg:flex font-[Roboto] font-bold text-[30px]">
          About Me
        </h2>
        <div className="mt-5">
          <p className="font-[AncizarSerif]  text-[20px] text-[rgba(255,255,255,0.7)]">
